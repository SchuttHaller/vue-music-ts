...
function toggleAudio(payload: any) {
  store.dispatch(ActionTypes.Player_ToggleAudio, payload);
}

function updateSeek(payload: any) {
  store.dispatch(ActionTypes.Player_SetSeek, payload);
}
</script>
<template>
  <!-- Player -->
